...
<div class="shopist-modal" id="subscriptions_modal" style="width:100px;">
  <div class="modal__window">
    ...
    <div class="modal__content">
      <div class="subscribe-content"><?php echo string_decode($subscriptions_data['popup_content']); ?></div>
      <div class="subscribe-options">
        <?php if($subscriptions_data['subscribe_options'] == 'email'): ?>
          <input type="text" id="subscribe_options_email"  placeholder="<?php echo e(trans('frontend.enter_email_label')); ?>" />
        <?php endif; ?>
        
        <?php if($subscriptions_data['subscribe_options'] == 'name_email'): ?>
          <input type="text" id="subscribe_options_name"  placeholder="<?php echo e(trans('frontend.enter_name_label')); ?>" />
          <input type="text" id="subscribe_options_email"  placeholder="<?php echo e(trans('frontend.enter_email_label')); ?>" />
        <?php endif; ?>
        
        <button type="button" id="subscribtion_submit"><?php echo $subscriptions_data['subscribe_btn_text']; ?></button>
      </div>
