(function(global){
	...
	var _dimensionAffectingProps=fabric.Text.prototype._dimensionAffectingProps;
        ...
        _dimensionAffectingProps['fontFamily']=true;
        _dimensionAffectingProps['lineHeight']=true;
        _dimensionAffectingProps['textAlign']=true;
        _dimensionAffectingProps['fontWeight']=true;
        _dimensionAffectingProps['textBackgroundColor']=true;
        _dimensionAffectingProps['stroke']=true;
        _dimensionAffectingProps['strokeWidth']=true;
        _dimensionAffectingProps['angle']=true;
        _dimensionAffectingProps['opacity']=true;
        _dimensionAffectingProps['flipX']=true;
        _dimensionAffectingProps['flipY']=true;
	_dimensionAffectingProps['effect']=true;
	_dimensionAffectingProps['width']=true;
	_dimensionAffectingProps['height']=true;
	_dimensionAffectingProps['range']=true;
	_dimensionAffectingProps['fontSize']=true;
	_dimensionAffectingProps['shadow']=false;
	_dimensionAffectingProps['effect']=true;
	_dimensionAffectingProps['range']=true;
